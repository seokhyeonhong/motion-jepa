...
- Learning rates: `0.1`, `0.3`, `0.5`, `0.7`, `1`
- Seeds: 42
- Epochs: 50
...
Values are from seed 42 and are reported in percent.
...
Across the evaluated range, validation top-1 spans 1.07 percentage points and test top-1 spans 1.19 percentage points.
...
Across the evaluated range, validation top-1 spans 0.61 percentage points and test top-1 spans 0.80 percentage points.
...
Across the evaluated range, validation top-1 spans 0.88 percentage points and test top-1 spans 0.80 percentage points.
...
Across the evaluated range, validation top-1 spans 1.07 percentage points and test top-1 spans 1.72 percentage points.
...
Across the evaluated range, validation top-1 spans 2.98 percentage points and test top-1 spans 3.48 percentage points.
...
Across the evaluated range, validation top-1 spans 1.95 percentage points and test top-1 spans 1.26 percentage points.
...
Across the evaluated range, validation top-1 spans 1.72 percentage points and test top-1 spans 3.21 percentage points.
...
Across the evaluated range, validation top-1 spans 1.49 percentage points and test top-1 spans 2.49 percentage points.
...
Across the evaluated range, validation top-1 spans 1.61 percentage points and test top-1 spans 0.69 percentage points.
...
Across the evaluated range, validation top-1 spans 1.19 percentage points and test top-1 spans 2.18 percentage points.
...
Across the evaluated range, validation top-1 spans 1.57 percentage points and test top-1 spans 1.38 percentage points.
...
Across the evaluated range, validation top-1 spans 8.15 percentage points and test top-1 spans 8.07 percentage points.
...
Across the evaluated range, validation top-1 spans 5.28 percentage points and test top-1 spans 7.42 percentage points.
...
Across the evaluated range, validation top-1 spans 1.61 percentage points and test top-1 spans 2.52 percentage points.
...
Across the evaluated range, validation top-1 spans 1.19 percentage points and test top-1 spans 0.80 percentage points.
